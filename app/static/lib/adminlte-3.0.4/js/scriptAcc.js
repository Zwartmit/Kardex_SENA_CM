    ...
    function addProductRow() {
        ...
        row.innerHTML = `
            ...
            <td class="delete-column">
                <i type="button" id="delete-row-${productRowCounter}" class="delete-row fas fa-trash-alt" style="color: #034231; font-size: 25px;"
                    onmouseover="this.style.color='#ff0000';"
                    onmouseout="this.style.color='#034231';"></i>
            </td>
    ...
    function addDishRow() {
        ...
        row.innerHTML = `
            ...
            <td class="delete-dish-column">
                <i type="button" id="delete-dish-row-${dishRowCounter}" class="delete-dish-row fas fa-trash-alt" style="color: #034231; font-size: 25px;"
                    onmouseover="this.style.color='#ff0000';"
                    onmouseout="this.style.color='#034231';"></i>
            </td>
    ...
    function addProductSaleRow() {
        ...
        row.innerHTML = `
            ...
            <td class="delete-sale-column">
                <i type="button" class="delete-row fas fa-trash-alt" style="color: #034231; font-size: 25px;"
                    onmouseover="this.style.color='#ff0000';"
                    onmouseout="this.style.color='#034231';"></i>
            </td>
