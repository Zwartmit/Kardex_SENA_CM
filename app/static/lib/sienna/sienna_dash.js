document.addEventListener("DOMContentLoaded", function () {
    ...
    <style>
        ...
        .asw-menu-header { display: flex; align-items: center; justify-content: space-between; background: #034231; color: #fff; padding-left: 12px; font-weight: 600; }
        ...
        .asw-footer { position: absolute; bottom: 0; left: 0; left: 0; background: #034231; padding: 16px; text-align: center; color: #fff; }
        ...
        .asw-adjust-font div[role=button] { background: #034231; border-radius: 50%; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; color: #fff; cursor: pointer; }
